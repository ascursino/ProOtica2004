...
Begin VB.Form FrmMedico_Alt 
   Caption         =   "Alteração de Médico"
   ClientHeight    =   7080
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6930
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":0CCA
         TabIndex        =   20
         Top             =   240
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":0D2C
         TabIndex        =   21
         Top             =   1680
         Width           =   1695
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":0DAC
         TabIndex        =   22
         Top             =   720
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":0E0C
         TabIndex        =   23
         Top             =   2160
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":0E76
         TabIndex        =   24
         Top             =   2640
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":0EDC
         TabIndex        =   25
         Top             =   3120
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   4440
         OleObjectBlob   =   "FrmMedico_Alt.frx":0F42
         TabIndex        =   26
         Top             =   1200
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   4440
         OleObjectBlob   =   "FrmMedico_Alt.frx":0FA6
         TabIndex        =   27
         Top             =   720
         Width           =   375
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   4440
         OleObjectBlob   =   "FrmMedico_Alt.frx":1006
         TabIndex        =   28
         Top             =   2640
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   4440
         OleObjectBlob   =   "FrmMedico_Alt.frx":1066
         TabIndex        =   29
         Top             =   3120
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":10CC
         TabIndex        =   30
         Top             =   3600
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   255
         Left            =   4440
         OleObjectBlob   =   "FrmMedico_Alt.frx":1136
         TabIndex        =   31
         Top             =   3600
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel13 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":119E
         TabIndex        =   32
         Top             =   1200
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel14 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":1202
         TabIndex        =   33
         Top             =   4560
         Width           =   1215
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel15 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmMedico_Alt.frx":1270
         TabIndex        =   34
         Top             =   4080
         Width           =   855
      End
   ...
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   1320
         OleObjectBlob   =   "FrmMedico_Alt.frx":12D0
         Top             =   240
      End
   ...
   End
End
Attribute VB_Name = "FrmMedico_Alt"
...
Private Sub CmdOK_Click()
    ...
    StrSql = "SELECT * FROM tb_Medico where CodMed=" & VGIntCodMed
...
Private Sub Form_Resize()
  FrmMedico_Alt.Left = (MDIPrincipal.Width / 2) - (FrmMedico_Alt.Width / 2)
  FrmMedico_Alt.Top = (MDIPrincipal.Height / 3) - (FrmMedico_Alt.Height / 3)
End Sub
...
Private Sub Form_Load()
    ...
    TxtNome.Text = VerificaNulo(RecMed!nome)
    TxtCrm.Text = VerificaNulo(RecMed!crm)
    TxtCpf.Text = VerificaNulo(RecMed!cpf)
    TxtEmail.Text = VerificaNulo(RecMed!email)
    
    If RecMed!dtnasc <> "" Then
        TxtDtNasc.Text = FormataData(VerificaNulo(RecMed!dtnasc))
    Else
        TxtDtNasc.Text = "__/__/____"
    End If
    
    TxtCliCons.Text = VerificaNulo(RecMed!clicons)
    TxtEndereco.Text = VerificaNulo(RecMed!endereco)
    TxtBairro.Text = VerificaNulo(RecMed!bairro)
    TxtCep.Text = VerificaNulo(RecMed!cep)
    TxtCidade.Text = VerificaNulo(RecMed!cidade)
    CboEstado.Text = VerificaNulo(RecMed!estado)
    
    If VerificaNulo(RecMed!telefone) <> "" Then
        If InStr(RecMed!telefone, "/") <> 0 Then
            VLStrTel1 = Mid(RecMed!telefone, 1, InStr(RecMed!telefone, "/") - 1)
            VLStrTel2 = Mid(RecMed!telefone, InStr(RecMed!telefone, "/") + 1)
        Else
            VLStrTel1 = RecMed!telefone
            VLStrTel2 = ""
        End If
    Else
        VLStrTel1 = ""
    ...
    TxtTel1.Text = VLStrTel1
    TxtTel2.Text = VLStrTel2
    TxtCel.Text = VerificaNulo(RecMed!celular)
    TxtFax.Text = RecMed!Fax
    TxtObs.Text = VerificaNulo(RecMed!obs)
