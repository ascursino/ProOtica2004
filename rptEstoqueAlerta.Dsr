VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptEstoqueAlerta 
   Bindings        =   "rptEstoqueAlerta.dsx":0000
   Caption         =   "Relatório de Alerta de Estoque (visualização)"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12150
   Icon            =   "rptEstoqueAlerta.dsx":001A
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item4 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Relatório de Alerta de Estoque"
         Alignment       =   2
      EndProperty
      ItemType5       =   3
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Sistema Integrado de Gestão de Óticas"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode4    =   8
   ...
   EndProperty
End
Attribute VB_Name = "rptEstoqueAlerta"
