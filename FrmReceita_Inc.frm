...
Private Sub CmdFechar_Click()
    VPStrResponse = MsgBox("Deseja incluir uma venda?", vbYesNo, "Pró Ótica 2004 - Informação")
...
Private Sub CmdOK_Click()
    ...
    VPStrBox = MsgBox("Receita cadastrada.", vbInformation, "Pró Ótica 2004 - Informação")
...
Private Sub TxtAdicAO_GotFocus()
    ...
    Else
        ...
        If OD <> OE Then
            VPStrBox = MsgBox("Problemas na geração da adição." & Chr(13) & "É possível que os dados estejam incorretos.", vbCritical, "Pró Ótica 2004 - Erro")
