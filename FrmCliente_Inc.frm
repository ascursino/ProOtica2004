...
Begin VB.Form FrmCliente_Inc 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CboEstado 
         Height          =   315
         ItemData        =   "FrmCliente_Inc.frx":0CCA
         Left            =   5160
         List            =   "FrmCliente_Inc.frx":0CCC
      ...
      Begin VB.ComboBox CboSexo 
         Height          =   315
         ItemData        =   "FrmCliente_Inc.frx":0CCE
         Left            =   1200
         List            =   "FrmCliente_Inc.frx":0CD0
         Style           =   2  'Dropdown List
         TabIndex        =   8
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":0CD2
         TabIndex        =   19
         Top             =   240
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":0D34
         TabIndex        =   20
         Top             =   720
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":0D9E
         TabIndex        =   21
         Top             =   1200
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":0E04
         TabIndex        =   22
         Top             =   1680
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   4320
         OleObjectBlob   =   "FrmCliente_Inc.frx":0E6A
         TabIndex        =   23
         Top             =   2160
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":0ECE
         TabIndex        =   24
         Top             =   2160
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   255
         Left            =   4320
         OleObjectBlob   =   "FrmCliente_Inc.frx":0F2E
         TabIndex        =   25
         Top             =   1200
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   4320
         OleObjectBlob   =   "FrmCliente_Inc.frx":0F8E
         TabIndex        =   26
         Top             =   1680
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":0FF6
         TabIndex        =   27
         Top             =   3120
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   255
         Left            =   4320
         OleObjectBlob   =   "FrmCliente_Inc.frx":1060
         TabIndex        =   28
         Top             =   2640
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":10C8
         TabIndex        =   29
         Top             =   3600
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":112C
         TabIndex        =   30
         Top             =   4080
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel13 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmCliente_Inc.frx":119A
         TabIndex        =   31
         Top             =   2640
         Width           =   615
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel14 
         Height          =   255
         Left            =   4320
         OleObjectBlob   =   "FrmCliente_Inc.frx":11FC
         TabIndex        =   32
         Top             =   3120
         Width           =   735
      End
   ...
   Begin VB.Frame FraBotaoCli 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   360
         OleObjectBlob   =   "FrmCliente_Inc.frx":125C
         Top             =   120
      End
   End
End
Attribute VB_Name = "FrmCliente_Inc"
...
Private Sub Form_Resize()
  FrmCliente_Inc.Left = (MDIPrincipal.Width / 2) - (FrmCliente_Inc.Width / 2)
  FrmCliente_Inc.Top = (MDIPrincipal.Height / 3) - (FrmCliente_Inc.Height / 3)
End Sub
