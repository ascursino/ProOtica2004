VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCarne 
   Bindings        =   "rptCarne.dsx":0000
   Caption         =   "Proposta de crédito (visualização)"
   ClientHeight    =   9090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12255
   Icon            =   "rptCarne.dsx":001A
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "CARNÊ DE PAGAMENTO"
         Alignment       =   2
      EndProperty
      ItemType2       =   7
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Endereço - Bairro"
         Alignment       =   2
      EndProperty
      ItemType6       =   3
      ...
      BeginProperty Item11 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Sistema Integrado de Gestão de Ótica"
         Alignment       =   2
      EndProperty
      ItemType12      =   3
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      EndProperty
      ItemType27      =   6
      BeginProperty Item27 {1C13A8E4-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "Shape11"
         Object.Left            =   680
         Object.Top             =   2265
      ...
      EndProperty
      ItemType57      =   6
      BeginProperty Item57 {1C13A8E4-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "Shape20"
         Object.Left            =   7707
         Object.Top             =   2265
      ...
      EndProperty
      ItemType58      =   6
      BeginProperty Item58 {1C13A8E4-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
         Name            =   "Shape21"
         Object.Left            =   6236
         Object.Top             =   2265
...
Private Sub DataReport_Initialize()
    ...
    Me.Sections.Item(1).Controls.Item("LblCliente").Caption = VGStrClienteRel

    If VGStrAssinaturaCarne = "branco" Then
        Me.Sections.Item(1).Controls.Item("LblEndBairro").Caption = ""
        Me.Sections.Item(1).Controls.Item("LblTel").Caption = ""
        Me.Sections.Item(1).Controls.Item("LblWeb").Caption = ""
    Else
        ...
        Else
            If IsNull(RecAss!logo) = False Then
                Set Me.Sections.Item(1).Controls.Item("ImgLogo").Picture = LoadPicture(RecAss!logo)
            End If
            
            If IsNull(RecAss!endereco) = False And IsNull(RecAss!bairro) = False Then
                Me.Sections.Item(1).Controls.Item("LblEndBairro").Caption = RecAss!endereco & " - " & RecAss!bairro
            ElseIf IsNull(RecAss!endereco) = False And IsNull(RecAss!bairro) = True Then
                Me.Sections.Item(1).Controls.Item("LblEndBairro").Caption = RecAss!endereco
            ElseIf IsNull(RecAss!endereco) = True And IsNull(RecAss!bairro) = False Then
                Me.Sections.Item(1).Controls.Item("LblEndBairro").Caption = RecAss!bairro
            ElseIf IsNull(RecAss!endereco) = True And IsNull(RecAss!bairro) = True Then
                Me.Sections.Item(1).Controls.Item("LblEndBairro").Caption = ""
            End If
            
            If IsNull(RecAss!telefone) = False Then
                Me.Sections.Item(1).Controls.Item("LblTel").Caption = RecAss!telefone
            Else
                Me.Sections.Item(1).Controls.Item("LblTel").Caption = ""
            End If
            
            If IsNull(RecAss!web) = False Then
                Me.Sections.Item(1).Controls.Item("LblWeb").Caption = RecAss!web
            Else
                Me.Sections.Item(1).Controls.Item("LblWeb").Caption = ""
            End If
        End If
